...
RECIPE_DB = [
    ...
    },
    {
        ...
        "ingredients": ["鶏肉", "chicken", "醤油", "soy sauce", "みりん", "mirin",
                        "砂糖", "sugar"],
        "url": "https://www.kurashiru.com/recipes/search?query=鶏の照り焼き",
        "category": "main",
        "time_minutes": 15,
    },
    {
        ...
        "ingredients": ["サバ", "mackerel", "味噌", "miso", "しょうが", "ginger",
                        "砂糖", "sugar", "酒", "sake"],
        "url": "https://www.kurashiru.com/recipes/search?query=サバの味噌煮",
        "category": "main",
        "time_minutes": 25,
    },
    {
        ...
        "url": "https://www.kurashiru.com/recipes/search?query=エビチリ",
        "category": "main",
        "time_minutes": 20,
    },
    {
        ...
        "url": "https://www.kurashiru.com/recipes/search?query=回鍋肉",
        "category": "main",
        "time_minutes": 15,
    },
    {
        ...
        "url": "https://www.kurashiru.com/recipes/search?query=チキン南蛮",
        "category": "main",
        "time_minutes": 30,
    },
    {
        ...
        "ingredients": ["ぶり", "yellowtail", "大根", "daikon", "しょうが", "ginger",
                        "醤油", "soy sauce", "みりん", "mirin"],
        "url": "https://www.kurashiru.com/recipes/search?query=ぶり大根",
        "category": "main",
        "time_minutes": 40,
    },
    {
        ...
        "url": "https://www.kurashiru.com/recipes/search?query=酢豚",
        "category": "main",
        "time_minutes": 30,
    },
    {
        ...
        "ingredients": ["牛肉", "beef", "豆腐", "tofu", "ねぎ", "green onion",
                        "醤油", "soy sauce", "みりん", "mirin"],
        "url": "https://www.kurashiru.com/recipes/search?query=肉豆腐",
        "category": "main",
        "time_minutes": 20,
    },
    {
        ...
        "ingredients": ["アジ", "horse mackerel", "小麦粉", "flour", "卵", "egg",
                        "パン粉", "breadcrumbs"],
        "url": "https://www.kurashiru.com/recipes/search?query=アジフライ",
        "category": "main",
        "time_minutes": 25,
    },
    {
        ...
        "ingredients": ["豚ロース", "pork loin", "小麦粉", "flour", "卵", "egg",
                        "パン粉", "breadcrumbs"],
        "url": "https://www.kurashiru.com/recipes/search?query=豚カツ",
        "category": "main",
        "time_minutes": 25,
    },
    {
        ...
        "url": "https://www.kurashiru.com/recipes/search?query=鶏つくね",
        "category": "main",
        "time_minutes": 20,
    },
    {
        ...
        "url": "https://www.kurashiru.com/recipes/search?query=タラのホイル焼き",
        "category": "main",
        "time_minutes": 20,
    },
    {
        ...
        "url": "https://www.kurashiru.com/recipes/search?query=餃子",
        "category": "main",
        "time_minutes": 35,
    },
    {
        ...
        "url": "https://www.kurashiru.com/recipes/search?query=クリームシチュー",
        "category": "main",
        "time_minutes": 40,
    },
    {
        ...
        "url": "https://www.kurashiru.com/recipes/search?query=麻婆なす",
        "category": "main",
        "time_minutes": 15,
    },
    {
        ...
        "url": "https://www.kurashiru.com/recipes/search?query=イカの煮物",
        "category": "main",
        "time_minutes": 25,
    },
    {
        ...
        "url": "https://www.kurashiru.com/recipes/search?query=ささみチーズ焼き",
        "category": "main",
        "time_minutes": 15,
    },
    {
        ...
        "url": "https://www.kurashiru.com/recipes/search?query=青椒肉絲",
        "category": "main",
        "time_minutes": 15,
    },
    {
        ...
        "ingredients": ["アサリ", "clams", "酒", "sake", "にんにく", "garlic",
                        "バター", "butter"],
        "url": "https://www.kurashiru.com/recipes/search?query=アサリの酒蒸し",
        "category": "main",
        "time_minutes": 10,
    },
    # === 副菜 (Side dishes) ===
    ...
    },
    {
        ...
        "url": "https://www.kurashiru.com/recipes/search?query=ほうれん草のおひたし",
        "category": "side",
        "time_minutes": 5,
    },
    {
        ...
        "url": "https://www.kurashiru.com/recipes/search?query=冷奴",
        "category": "side",
        "time_minutes": 3,
    },
    {
        ...
        "ingredients": ["もやし", "bean sprouts", "ほうれん草", "spinach", "にんじん", "carrot",
                        "ごま油", "sesame oil"],
        "url": "https://www.kurashiru.com/recipes/search?query=ナムル",
        "category": "side",
        "time_minutes": 10,
    },
    {
        ...
        "url": "https://www.kurashiru.com/recipes/search?query=卵焼き",
        "category": "side",
        "time_minutes": 10,
    },
    {
        ...
        "ingredients": ["ひじき", "hijiki", "にんじん", "carrot", "油揚げ", "fried tofu",
                        "醤油", "soy sauce", "みりん", "mirin"],
        "url": "https://www.kurashiru.com/recipes/search?query=ひじきの煮物",
        "category": "side",
        "time_minutes": 20,
    },
    {
        ...
        "ingredients": ["豆腐", "tofu", "ほうれん草", "spinach", "にんじん", "carrot",
                        "ごま", "sesame"],
        "url": "https://www.kurashiru.com/recipes/search?query=白和え",
        "category": "side",
        "time_minutes": 15,
    },
    {
        ...
        "url": "https://www.kurashiru.com/recipes/search?query=かぼちゃの煮物",
        "category": "side",
        "time_minutes": 20,
    },
    {
        ...
        "url": "https://www.kurashiru.com/recipes/search?query=もやしのごま和え",
        "category": "side",
        "time_minutes": 5,
    },
    {
        ...
        "url": "https://www.kurashiru.com/recipes/search?query=ブロッコリーおかか和え",
        "category": "side",
        "time_minutes": 5,
    },
    {
        ...
        "ingredients": ["なす", "eggplant", "醤油", "soy sauce", "だし", "dashi",
                        "しょうが", "ginger"],
        "url": "https://www.kurashiru.com/recipes/search?query=なすの煮浸し",
        "category": "side",
        "time_minutes": 15,
    },
    {
        ...
        "url": "https://www.kurashiru.com/recipes/search?query=大根サラダ",
        "category": "side",
        "time_minutes": 10,
    },
    {
        ...
        "ingredients": ["ピーマン", "bell pepper", "かつお節", "bonito flakes",
                        "醤油", "soy sauce", "ごま油", "sesame oil"],
        "url": "https://www.kurashiru.com/recipes/search?query=ピーマンおかか炒め",
        "category": "side",
        "time_minutes": 5,
    },
    {
        ...
        "url": "https://www.kurashiru.com/recipes/search?query=きゅうりの漬物",
        "category": "side",
        "time_minutes": 5,
    },
    {
        ...
        "ingredients": ["キャベツ", "cabbage", "にんじん", "carrot", "マヨネーズ", "mayonnaise",
                        "酢", "vinegar"],
        "url": "https://www.kurashiru.com/recipes/search?query=コールスロー",
        "category": "side",
        "time_minutes": 10,
    },
    {
        ...
        "url": "https://www.kurashiru.com/recipes/search?query=マカロニサラダ",
        "category": "side",
        "time_minutes": 15,
    },
    {
        ...
        "ingredients": ["切り干し大根", "dried daikon", "にんじん", "carrot", "油揚げ", "fried tofu",
                        "醤油", "soy sauce"],
        "url": "https://www.kurashiru.com/recipes/search?query=切り干し大根",
        "category": "side",
        "time_minutes": 20,
    },
    {
        ...
        "ingredients": ["豆腐", "tofu", "片栗粉", "potato starch", "だし", "dashi",
                        "醤油", "soy sauce"],
        "url": "https://www.kurashiru.com/recipes/search?query=揚げ出し豆腐",
        "category": "side",
        "time_minutes": 15,
    },
    {
        ...
        "url": "https://www.kurashiru.com/recipes/search?query=カプレーゼ",
        "category": "side",
        "time_minutes": 5,
    },
    # === 汁物 (Soups) ===
    ...
    },
    {
        ...
        "url": "https://www.kurashiru.com/recipes/search?query=豚汁",
        "category": "soup",
        "time_minutes": 25,
    },
    {
        ...
        "url": "https://www.kurashiru.com/recipes/search?query=けんちん汁",
        "category": "soup",
        "time_minutes": 25,
    },
    {
        ...
        "ingredients": ["コーン", "corn", "牛乳", "milk", "バター", "butter",
                        "玉ねぎ", "onion"],
        "url": "https://www.kurashiru.com/recipes/search?query=コーンスープ",
        "category": "soup",
        "time_minutes": 15,
    },
    {
        ...
        "url": "https://www.kurashiru.com/recipes/search?query=かきたま汁",
        "category": "soup",
        "time_minutes": 5,
    },
    {
        ...
        "url": "https://www.kurashiru.com/recipes/search?query=わかめスープ",
        "category": "soup",
        "time_minutes": 5,
    },
    {
        ...
        "url": "https://www.kurashiru.com/recipes/search?query=ミネストローネ",
        "category": "soup",
        "time_minutes": 25,
    },
    {
        ...
        "ingredients": ["アサリ", "clams", "じゃがいも", "potato", "玉ねぎ", "onion",
                        "牛乳", "milk", "バター", "butter"],
        "url": "https://www.kurashiru.com/recipes/search?query=クラムチャウダー",
        "category": "soup",
        "time_minutes": 30,
    },
    {
        ...
        "url": "https://www.kurashiru.com/recipes/search?query=キムチチゲ",
        "category": "soup",
        "time_minutes": 20,
    },
    {
        ...
        "ingredients": ["卵", "egg", "わかめ", "wakame", "ねぎ", "green onion",
                        "ごま油", "sesame oil"],
        "url": "https://www.kurashiru.com/recipes/search?query=中華スープ",
        "category": "soup",
        "time_minutes": 5,
    },
    {
        ...
        "ingredients": ["玉ねぎ", "onion", "バター", "butter", "チーズ", "cheese",
                        "パン", "bread"],
        "url": "https://www.kurashiru.com/recipes/search?query=オニオンスープ",
        "category": "soup",
        "time_minutes": 30,
    },
    {
        ...
        "ingredients": ["なめこ", "nameko", "豆腐", "tofu", "味噌", "miso",
                        "ねぎ", "green onion"],
        "url": "https://www.kurashiru.com/recipes/search?query=なめこの味噌汁",
        "category": "soup",
        "time_minutes": 10,
    },
    {
        ...
        "ingredients": ["キャベツ", "cabbage", "にんじん", "carrot", "玉ねぎ", "onion",
                        "ベーコン", "bacon"],
        "url": "https://www.kurashiru.com/recipes/search?query=野菜コンソメスープ",
        "category": "soup",
        "time_minutes": 15,
    },
    # === 丼 (Bowl dishes) ===
    ...
    },
    {
        ...
        "ingredients": ["牛肉", "beef", "玉ねぎ", "onion", "ご飯", "rice",
                        "醤油", "soy sauce", "みりん", "mirin"],
        "url": "https://www.kurashiru.com/recipes/search?query=牛丼",
        "category": "bowl",
        "time_minutes": 15,
    },
    {
        ...
        "url": "https://www.kurashiru.com/recipes/search?query=豚丼",
        "category": "bowl",
        "time_minutes": 15,
    },
    {
        ...
        "url": "https://www.kurashiru.com/recipes/search?query=カツ丼",
        "category": "bowl",
        "time_minutes": 25,
    },
    {
        ...
        "ingredients": ["卵", "egg", "カニカマ", "crab stick", "ご飯", "rice",
                        "ねぎ", "green onion"],
        "url": "https://www.kurashiru.com/recipes/search?query=天津飯",
        "category": "bowl",
        "time_minutes": 15,
    },
    {
        ...
        "ingredients": ["刺身", "sashimi", "ご飯", "rice", "わさび", "wasabi",
                        "醤油", "soy sauce"],
        "url": "https://www.kurashiru.com/recipes/search?query=海鮮丼",
        "category": "bowl",
        "time_minutes": 10,
    },
    {
        ...
        "url": "https://www.kurashiru.com/recipes/search?query=中華丼",
        "category": "bowl",
        "time_minutes": 20,
    },
    {
        ...
        "url": "https://www.kurashiru.com/recipes/search?query=そぼろ丼",
        "category": "bowl",
        "time_minutes": 15,
    },
    {
        ...
        "url": "https://www.kurashiru.com/recipes/search?query=ネギトロ丼",
        "category": "bowl",
        "time_minutes": 5,
    },
    {
        ...
        "ingredients": ["しらす", "whitebait", "ご飯", "rice", "卵", "egg",
                        "醤油", "soy sauce"],
        "url": "https://www.kurashiru.com/recipes/search?query=しらす丼",
        "category": "bowl",
        "time_minutes": 5,
    },
    {
        ...
        "url": "https://www.kurashiru.com/recipes/search?query=鉄火丼",
        "category": "bowl",
        "time_minutes": 5,
    },
    {
        ...
        "ingredients": ["ひき肉", "ground meat", "レタス", "lettuce", "トマト", "tomato",
                        "チーズ", "cheese", "ご飯", "rice"],
        "url": "https://www.kurashiru.com/recipes/search?query=タコライス",
        "category": "bowl",
        "time_minutes": 15,
    },
    # === 麺 (Noodle dishes) ===
    {
        ...
        "ingredients": ["パスタ", "pasta", "ウインナー", "sausage", "ピーマン", "bell pepper",
                        "玉ねぎ", "onion", "ケチャップ", "ketchup"],
        "url": "https://www.kurashiru.com/recipes/search?query=ナポリタン",
        "category": "noodle",
        "time_minutes": 15,
    },
    {
        ...
        "ingredients": ["パスタ", "pasta", "ベーコン", "bacon", "卵", "egg",
                        "チーズ", "cheese", "牛乳", "milk"],
        "url": "https://www.kurashiru.com/recipes/search?query=カルボナーラ",
        "category": "noodle",
        "time_minutes": 20,
    },
    {
        ...
        "url": "https://www.kurashiru.com/recipes/search?query=和風パスタ",
        "category": "noodle",
        "time_minutes": 15,
    },
    {
        ...
        "ingredients": ["パスタ", "pasta", "にんにく", "garlic", "唐辛子", "chili",
                        "オリーブオイル", "olive oil"],
        "url": "https://www.kurashiru.com/recipes/search?query=ペペロンチーノ",
        "category": "noodle",
        "time_minutes": 15,
    },
    {
        ...
        "ingredients": ["うどん", "udon", "油揚げ", "fried tofu", "ねぎ", "green onion",
                        "だし", "dashi"],
        "url": "https://www.kurashiru.com/recipes/search?query=きつねうどん",
        "category": "noodle",
        "time_minutes": 10,
    },
    {
        ...
        "url": "https://www.kurashiru.com/recipes/search?query=カレーうどん",
        "category": "noodle",
        "time_minutes": 15,
    },
    {
        ...
        "url": "https://www.kurashiru.com/recipes/search?query=担々麺",
        "category": "noodle",
        "time_minutes": 20,
    },
    {
        ...
        "ingredients": ["中華麺", "noodles", "卵", "egg", "きゅうり", "cucumber",
                        "ハム", "ham", "トマト", "tomato"],
        "url": "https://www.kurashiru.com/recipes/search?query=冷やし中華",
        "category": "noodle",
        "time_minutes": 15,
    },
    {
        ...
        "url": "https://www.kurashiru.com/recipes/search?query=焼うどん",
        "category": "noodle",
        "time_minutes": 10,
    },
    {
        ...
        "url": "https://www.kurashiru.com/recipes/search?query=鍋焼きうどん",
        "category": "noodle",
        "time_minutes": 20,
    },
    {
        ...
        "ingredients": ["そうめん", "somen", "ツナ缶", "canned tuna", "にんじん", "carrot",
                        "ニラ", "chives", "卵", "egg"],
        "url": "https://www.kurashiru.com/recipes/search?query=ソーメンチャンプルー",
        "category": "noodle",
        "time_minutes": 15,
    },
    {
        ...
        "ingredients": ["パスタ", "pasta", "たらこ", "cod roe", "バター", "butter",
                        "海苔", "nori"],
        "url": "https://www.kurashiru.com/recipes/search?query=たらこパスタ",
        "category": "noodle",
        "time_minutes": 15,
    },
    {
        ...
        "ingredients": ["パスタ", "pasta", "明太子", "mentaiko", "牛乳", "milk",
                        "バター", "butter"],
        "url": "https://www.kurashiru.com/recipes/search?query=明太子クリームパスタ",
        "category": "noodle",
        "time_minutes": 15,
    },
    {
        ...
        "url": "https://www.kurashiru.com/recipes/search?query=ミートソース",
        "category": "noodle",
        "time_minutes": 30,
    },
    # === Additional main dishes to reach 100+ ===
    {
        ...
        "url": "https://www.kurashiru.com/recipes/search?query=肉巻きおにぎり",
        "category": "main",
        "time_minutes": 15,
    },
    {
        ...
        "url": "https://www.kurashiru.com/recipes/search?query=チーズタッカルビ",
        "category": "main",
        "time_minutes": 20,
    },
    {
        ...
        "ingredients": ["鮭", "salmon", "キャベツ", "cabbage", "玉ねぎ", "onion",
                        "味噌", "miso", "バター", "butter"],
        "url": "https://www.kurashiru.com/recipes/search?query=鮭のちゃんちゃん焼き",
        "category": "main",
        "time_minutes": 20,
    },
    {
        ...
        "ingredients": ["豆腐", "tofu", "豚肉", "pork", "もやし", "bean sprouts",
                        "ニラ", "chives", "卵", "egg"],
        "url": "https://www.kurashiru.com/recipes/search?query=豆腐チャンプルー",
        "category": "main",
        "time_minutes": 10,
    },
    {
        ...
        "url": "https://www.kurashiru.com/recipes/search?query=鶏のさっぱり煮",
        "category": "main",
        "time_minutes": 25,
    },
    {
        ...
        "url": "https://www.kurashiru.com/recipes/search?query=ツナマヨおにぎり",
        "category": "main",
        "time_minutes": 5,
    },
    {
        ...
        "url": "https://www.kurashiru.com/recipes/search?query=エビマヨ",
        "category": "main",
        "time_minutes": 15,
    },
    {
        ...
        "url": "https://www.kurashiru.com/recipes/search?query=焼き鮭",
        "category": "main",
        "time_minutes": 10,
    },
    {
        ...
        "ingredients": ["卵", "egg"],
        "url": "https://www.kurashiru.com/recipes/search?query=目玉焼き",
        "category": "side",
        "time_minutes": 3,
    },
    {
        ...
        "url": "https://www.kurashiru.com/recipes/search?query=ウインナー炒め",
        "category": "side",
        "time_minutes": 5,
    },
    {
        ...
        "url": "https://www.kurashiru.com/recipes/search?query=ベーコンエッグ",
        "category": "main",
        "time_minutes": 5,
    },
    {
        ...
        "url": "https://www.kurashiru.com/recipes/search?query=トースト",
        "category": "main",
        "time_minutes": 3,
    },
    {
        ...
        "url": "https://www.kurashiru.com/recipes/search?query=フレンチトースト",
        "category": "main",
        "time_minutes": 10,
    },
    {
        ...
        "url": "https://www.kurashiru.com/recipes/search?query=おにぎり",
        "category": "main",
        "time_minutes": 5,
    },
    {
        ...
        "url": "https://www.kurashiru.com/recipes/search?query=卵かけご飯",
        "category": "bowl",
        "time_minutes": 2,
    },
    {
        ...
        "url": "https://www.kurashiru.com/recipes/search?query=納豆ご飯",
        "category": "bowl",
        "time_minutes": 2,
    },
    {
        ...
        "url": "https://www.kurashiru.com/recipes/search?query=お茶漬け",
        "category": "bowl",
        "time_minutes": 3,
    },
    {
        ...
        "url": "https://www.kurashiru.com/recipes/search?query=雑炊",
        "category": "bowl",
        "time_minutes": 10,
    },
    {
        ...
        "url": "https://www.kurashiru.com/recipes/search?query=豆腐の味噌汁",
        "category": "soup",
        "time_minutes": 5,
    },
    {
        ...
        "url": "https://www.kurashiru.com/recipes/search?query=スクランブルエッグ",
        "category": "side",
        "time_minutes": 5,
    },
    {
        ...
        "ingredients": ["ツナ缶", "canned tuna", "レタス", "lettuce", "トマト", "tomato",
                        "きゅうり", "cucumber"],
        "url": "https://www.kurashiru.com/recipes/search?query=ツナサラダ",
        "category": "side",
        "time_minutes": 5,
    },
    {
        ...
        "url": "https://www.kurashiru.com/recipes/search?query=しらすトースト",
        "category": "main",
        "time_minutes": 5,
    },
    {
        ...
        "ingredients": ["豚肉", "pork", "レタス", "lettuce", "トマト", "tomato",
                        "きゅうり", "cucumber"],
        "url": "https://www.kurashiru.com/recipes/search?query=豚しゃぶサラダ",
        "category": "main",
        "time_minutes": 15,
    },
]
